#
# Be sure to run `pod lib lint DataCollectorClient.podspec' to ensure this is a
...
Pod::Spec.new do |s|
    s.name             = "DataCollectorClient"
    s.version          = "1.0.0"

    s.summary          = "Knetik.io Data Collector REST API"
    s.description      = <<-DESC
    ...
    s.source_files = 'DataCollectorClient/**/*.{m,h}'
    s.public_header_files = 'DataCollectorClient/**/*.h'
