...
@interface DCCDebuggingApi: NSObject <DCCApi>

extern NSString* kDCCDebuggingApiErrorDomain;
extern NSInteger kDCCDebuggingApiMissingParamErrorCode;
...
/// @param customerId customerId
/// 
///  code:202 message:"Successfully enabled debugging",
