#import "DCCDebuggingApi.h"
#import "DCCQueryParamCollection.h"
#import "DCCApiClient.h"


@interface DCCDebuggingApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation DCCDebuggingApi

NSString* kDCCDebuggingApiErrorDomain = @"DCCDebuggingApiErrorDomain";
NSInteger kDCCDebuggingApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) disableDebuggerUsingDELETEWithCustomerId: (NSString*) customerId
    ...
    if (customerId == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kDCCDebuggingApiErrorDomain code:kDCCDebuggingApiMissingParamErrorCode userInfo:userInfo];
            handler(error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/v2/_debug/{customerId}"];
