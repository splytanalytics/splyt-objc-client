#import "DCCEventsApi.h"
#import "DCCQueryParamCollection.h"
#import "DCCApiClient.h"
#import "DCCNewEventRequest.h"


@interface DCCEventsApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation DCCEventsApi

NSString* kDCCEventsApiErrorDomain = @"DCCEventsApiErrorDomain";
NSInteger kDCCEventsApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) createEventWithCustomerId: (NSString*) customerId
    ...
    if (customerId == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kDCCEventsApiErrorDomain code:kDCCEventsApiMissingParamErrorCode userInfo:userInfo];
            handler(error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/v2/events"];
