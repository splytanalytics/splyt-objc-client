...
@interface DCCMobileApplicationTrackingApi: NSObject <DCCApi>

extern NSString* kDCCMobileApplicationTrackingApiErrorDomain;
extern NSInteger kDCCMobileApplicationTrackingApiMissingParamErrorCode;
