#import "SWGDebuggingApi.h"
#import "SWGQueryParamCollection.h"
#import "SWGApiClient.h"


@interface SWGDebuggingApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation SWGDebuggingApi

NSString* kSWGDebuggingApiErrorDomain = @"SWGDebuggingApiErrorDomain";
NSInteger kSWGDebuggingApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) disableDebuggerUsingDELETEWithCustomerId: (NSString*) customerId
    ...
    if (customerId == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGDebuggingApiErrorDomain code:kSWGDebuggingApiMissingParamErrorCode userInfo:userInfo];
            handler(error);
        }
        return nil;
    }
