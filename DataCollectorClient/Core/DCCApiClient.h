 ...
 */
extern NSString *const DCCResponseObjectErrorKey;


@interface DCCApiClient : AFHTTPSessionManager

@property (nonatomic, strong, readonly) id<DCCConfiguration> configuration;

@property(nonatomic, assign) NSTimeInterval timeoutInterval;

@property(nonatomic, strong) id<DCCResponseDeserializer> responseDeserializer;

@property(nonatomic, strong) id<DCCSanitizer> sanitizer;
