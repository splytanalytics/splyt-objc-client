...
#import "DCCBasicAuthTokenProvider.h"
#import "DCCLogger.h"

@interface DCCDefaultConfiguration ()
...
@implementation DCCDefaultConfiguration

#pragma mark - Singleton Methods

+ (instancetype) sharedConfig {
    static DCCDefaultConfiguration *shardConfig = nil;
...
- (instancetype) init {
    ...
    if (self) {
        ...
        _logger = [DCCLogger sharedLogger];
    }
    return self;
}
...
- (NSString *) getBasicAuthToken {
    ...
    NSString *basicAuthToken = [DCCBasicAuthTokenProvider createBasicAuthTokenWithUsername:self.username password:self.password];
