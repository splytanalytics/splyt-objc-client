#import "DCCResponseDeserializer.h"
#import <JSONModel/JSONModel.h>
#import <ISO8601/ISO8601.h>

NSString *const DCCDeserializationErrorDomainKey = @"DCCDeserializationErrorDomainKey";

NSInteger const DCCTypeMismatchErrorCode = 143553;

NSInteger const DCCEmptyValueOccurredErrorCode = 143509;

NSInteger const DCCUnknownResponseObjectErrorCode = 143528;


@interface DCCResponseDeserializer ()
...
@implementation DCCResponseDeserializer
...
-(NSError *)typeMismatchErrorWithExpectedType:(NSString *)expected data:(id)data {
    ...
    return [NSError errorWithDomain:DCCDeserializationErrorDomainKey code:DCCTypeMismatchErrorCode userInfo:userInfo];
}
...
-(NSError *)emptyValueOccurredError {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:DCCDeserializationErrorDomainKey code:DCCEmptyValueOccurredErrorCode userInfo:userInfo];
}
...
-(NSError *)unknownResponseErrorWithExpectedType:(NSString *)expected data:(id)data  {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:DCCDeserializationErrorDomainKey code:DCCUnknownResponseObjectErrorCode userInfo:userInfo];
}
