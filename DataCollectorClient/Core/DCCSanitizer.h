...
extern NSString * DCCPercentEscapedStringFromString(NSString *string);

extern NSString * const kDCCApplicationJSONType;

@protocol DCCSanitizer <NSObject>
...
@interface DCCSanitizer : NSObject <DCCSanitizer>
