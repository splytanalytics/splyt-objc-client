#import "DCCSanitizer.h"
#import "DCCObject.h"
#import "DCCQueryParamCollection.h"
#import <ISO8601/ISO8601.h>

NSString * const kDCCApplicationJSONType = @"application/json";

NSString * DCCPercentEscapedStringFromString(NSString *string) {
    static NSString * const kDCCCharactersGeneralDelimitersToEncode = @":#[]@";
    static NSString * const kDCCCharactersSubDelimitersToEncode = @"!$&'()*+,;=";

    NSMutableCharacterSet * allowedCharacterSet = [[NSCharacterSet URLQueryAllowedCharacterSet] mutableCopy];
    [allowedCharacterSet removeCharactersInString:[kDCCCharactersGeneralDelimitersToEncode stringByAppendingString:kDCCCharactersSubDelimitersToEncode]];
...
- (id) sanitizeForSerialization:(id) object {
    ...
    else if ([object isKindOfClass:[NSString class]] || [object isKindOfClass:[NSNumber class]] || [object isKindOfClass:[DCCQueryParamCollection class]]) {
        return object;
    }
    ...
    else if ([object isKindOfClass:[DCCObject class]]) {
...
- (NSString *) selectHeaderAccept:(NSArray *)accepts {
    ...
    for (NSString *string in accepts) {
        if ([self.jsonHeaderTypeExpression matchesInString:string options:0 range:NSMakeRange(0, [string length])].count > 0) {
            return kDCCApplicationJSONType;
        }
