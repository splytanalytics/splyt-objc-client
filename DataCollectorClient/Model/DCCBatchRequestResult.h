...
@protocol DCCBatchRequestResult
@end

@interface DCCBatchRequestResult : DCCObject

/* HTTP response code for the processed request [optional]
 */
@property(nonatomic) NSNumber* code;
/* Error messages if the request could not be processed [optional]
 */
@property(nonatomic) NSArray<NSString*>* errors;
/* The request. Will be null if request was successfully processed [optional]
 */
@property(nonatomic) DCCDataCollectorBaseRequest* request;
