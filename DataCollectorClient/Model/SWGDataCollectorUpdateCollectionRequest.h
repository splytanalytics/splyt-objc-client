...
@protocol SWGDataCollectorUpdateCollectionRequest
@end

@interface SWGDataCollectorUpdateCollectionRequest : SWGObject
 ...
 */
@property(nonatomic) NSNumber* balanceModification;
