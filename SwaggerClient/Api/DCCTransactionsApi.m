...
@interface DCCTransactionsApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation DCCTransactionsApi

NSString* kDCCTransactionsApiErrorDomain = @"DCCTransactionsApiErrorDomain";
NSInteger kDCCTransactionsApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) beginTransactionUsingPOSTWithCustomerId: (NSString*) customerId
    ...
    if (customerId == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kDCCTransactionsApiErrorDomain code:kDCCTransactionsApiMissingParamErrorCode userInfo:userInfo];
            handler(error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/v2/transactions"];
...
-(NSURLSessionTask*) endTransactionUsingPUTWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/v2/transactions/{id}/end"];
...
-(NSURLSessionTask*) updateCollectionUsingPOSTWithCustomerId: (NSString*) customerId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/v2/collections"];
...
-(NSURLSessionTask*) updateTransactionUsingPUTWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/v2/transactions/{id}"];
