...
NSString* kSWGEventsApiErrorDomain = @"SWGEventsApiErrorDomain";
NSInteger kSWGEventsApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) createEventUsingPOSTWithCustomerId: (NSString*) customerId
    ...
    if (customerId == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGEventsApiErrorDomain code:kSWGEventsApiMissingParamErrorCode userInfo:userInfo];
            handler(error);
        }
        return nil;
    }
