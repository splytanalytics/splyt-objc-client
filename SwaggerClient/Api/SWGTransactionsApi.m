...
@interface SWGTransactionsApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation SWGTransactionsApi

NSString* kSWGTransactionsApiErrorDomain = @"SWGTransactionsApiErrorDomain";
NSInteger kSWGTransactionsApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) beginTransactionUsingPOSTWithCustomerId: (NSString*) customerId
    ...
    if (customerId == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGTransactionsApiErrorDomain code:kSWGTransactionsApiMissingParamErrorCode userInfo:userInfo];
            handler(error);
        }
        return nil;
    }
